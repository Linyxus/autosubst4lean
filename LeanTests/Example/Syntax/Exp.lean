...
| abs {cs : CaptureSet s} : Exp.IsVal (.abs cs T e)
| tabs {cs : CaptureSet s} : Exp.IsVal (.tabs cs T e)
| cabs {cs : CaptureSet s} {cb : CaptureBound s} : Exp.IsVal (.cabs cs cb e)
| pack {cs : CaptureSet s} : Exp.IsVal (.pack cs x)
| unit : Exp.IsVal .unit
...
| abs {cs : CaptureSet s} : Exp.IsSimpleVal (.abs cs T e)
| tabs {cs : CaptureSet s} : Exp.IsSimpleVal (.tabs cs T e)
| cabs {cs : CaptureSet s} {cb : CaptureBound s} : Exp.IsSimpleVal (.cabs cs cb e)
...
| pack {cs : CaptureSet s} : Exp.IsPack (.pack cs x)
...
| abs {cs : CaptureSet s} : CaptureSet.IsClosed cs -> Ty.IsClosed T -> Exp.IsClosed e ->
    Exp.IsClosed (.abs cs T e)
| tabs {cs : CaptureSet s} : CaptureSet.IsClosed cs -> Ty.IsClosed T -> Exp.IsClosed e ->
    Exp.IsClosed (.tabs cs T e)
| cabs {cs : CaptureSet s} {cb : CaptureBound s} :
    CaptureSet.IsClosed cs -> CaptureBound.IsClosed cb -> Exp.IsClosed e ->
    Exp.IsClosed (.cabs cs cb e)
| pack {cs : CaptureSet s} : CaptureSet.IsClosed cs -> Var.IsClosed x ->
    Exp.IsClosed (.pack cs x)
| app : Var.IsClosed x -> Var.IsClosed y -> Exp.IsClosed (.app x y)
| tapp : Var.IsClosed x -> Ty.IsClosed T -> Exp.IsClosed (.tapp x T)
| capp {cs : CaptureSet s} : Var.IsClosed x -> CaptureSet.IsClosed cs ->
    Exp.IsClosed (.capp x cs)
...
| cond : Var.IsClosed x -> Exp.IsClosed e2 -> Exp.IsClosed e3 ->
    Exp.IsClosed (.cond x e2 e3)
